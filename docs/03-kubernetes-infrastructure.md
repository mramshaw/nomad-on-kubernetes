...
nomad  us-west1-b     1.7.3           XX.XXX.XXX.XX  n1-standard-1  1.7.3         4          PROVISIONING
```
...
```
NAME   ZONE           MASTER_VERSION  MASTER_IP      MACHINE_TYPE   NODE_VERSION  NUM_NODES  STATUS
nomad  us-west1-b     1.7.3           XX.XXX.XXX.XX  n1-standard-1  1.7.3         4          RUNNING
```
...
vault-pool    n1-standard-1  100           1.7.3
```
...
```
NAME   ZONE           MASTER_VERSION  MASTER_IP      MACHINE_TYPE   NODE_VERSION  NUM_NODES  STATUS
nomad  us-west1-b     1.7.3           XXX.XXX.XX.XX  n1-standard-1  1.7.3         6          RECONCILING
```
...
```
NAME   ZONE           MASTER_VERSION  MASTER_IP      MACHINE_TYPE   NODE_VERSION  NUM_NODES  STATUS
nomad  us-west1-b     1.7.3           XXX.XXX.XX.XX  n1-standard-1  1.7.3         6          RUNNING
```
